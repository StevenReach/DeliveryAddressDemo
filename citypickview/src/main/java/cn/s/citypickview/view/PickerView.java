package cn.s.citypickview.view;
...
import cn.s.citypickview.adapter.DataAdapter;
...
public class PickerView extends PopupWindow implements View.OnClickListener {
    ...
    private LinearLayout pBackground;
    ...
    private void initView() {
        ...
        pBackground = view.findViewById(R.id.ll_background);
    ...
    public void show(View view) {
        ...
        context.getWindow().setAttributes(lp);
        initData();
        pBackground.getBackground().setAlpha(127);
